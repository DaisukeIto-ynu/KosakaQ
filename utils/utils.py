# -*- coding: utf-8 -*-
"""
Created on Thu Oct 27 17:49:49 2022
...
def setup_logger(logger: logging.Logger) -> None:
    ...
    It involves:
        * Use the `QISKIT_KosakaQ_PROVIDER_LOG_LEVEL` environment variable to
        ...
        * Use the `QISKIT_KosakaQ_PROVIDER_LOG_FILE` environment variable to specify the
    ...
    """
    log_level = os.getenv('QISKIT_KosakaQ_PROVIDER_LOG_LEVEL', '')
    log_file = os.getenv('QISKIT_KosakaQ_PROVIDER_LOG_FILE', '')
